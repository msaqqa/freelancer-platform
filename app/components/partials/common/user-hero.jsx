...
export function UserHero({ user, isLoading, openDialog }) {
  ...
  const info = [
    {
      ...
      skeleton: (
        <div className="flex items-center gap-1.5">
          <Skeleton className="inline-flex size-6 m-0" />
    ...
    >
      <Container>
        <div className="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
          ...
          <div className="flex flex-wrap justify-center gap-2.5 lg:gap-4.5 text-sm">
            {buildInfo(info)}
          </div>
        </div>
      </Container>
